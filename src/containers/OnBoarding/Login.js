    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <div className="tagline">Please signin to your account</div>
                <BrowserRouter>
                    <Form onSubmit={this.handleSubmit} layout="vertical" hideRequiredMark>
                        ...
                        <Form.Item>
                            ...
                            <p className="center size">Don't have an account? <a onClick={this.routeHandler}> Signup </a></p>
                            {/*<Button type="primary" htmlType="submit" className="btn-size"> Signup </Button>*/}
                        </Form.Item>
                    </Form>
                </BrowserRouter>
            </div>
