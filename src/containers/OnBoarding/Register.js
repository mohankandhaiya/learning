    ...
    render() {
        ...
        return (
            <div className="container-register">
                ...
                <div className="tagline">Join our growing community</div>
                <Form onSubmit={this.handleSubmit} className="login-form" layout="vertical" hideRequiredMark>
                    ...
                    <Form.Item>
                        <Button type="primary" htmlType="submit" className="btn-size margin-top"> Register </Button>
                        <Divider orientation="center">OR</Divider>
                        <p className="center size">Are you existing user? <a onClick={this.routeHandler}> Login </a></p>
                    </Form.Item>
                </Form>
            </div>
        )
